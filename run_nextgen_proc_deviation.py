...
if not os.path.isfile(basedir+"query_histogram.pdf"):
    cmd_make_query_histo="python /Users/security/science/software/ISsuite/makehistogram.py -in_csv="+basedir+"query_summary.csv"+" -out="+basedir+"query_histogram.pdf"
